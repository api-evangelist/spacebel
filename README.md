...
|---|---|---|---|
| `spacebel:ogc-web-services` | Spacebel s.a OGC Web Services (WMS / WFS) | https://gis.spacebel.be/geoserver/ows | 2 GetCapabilities |
